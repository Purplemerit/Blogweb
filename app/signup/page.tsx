    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-serif italic text-neutral-900">Create Your Account</h1>
          <p className="text-sm text-neutral-500 mt-1">Already have an account? <Link href="/login" className="underline font-medium">Login here</Link></p>
        </div>
