...
interface ImageData {
  ...
  alt?: string;
  caption?: string;
  source: 'UPLOAD' | 'STOCK_PEXELS' | 'STOCK_UNSPLASH';
  createdAt: string;
}
    ...
    <div className="w-full max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
        <button
          ...
          className={`px-6 py-3 font-medium ${activeTab === 'library'
        ...
        <button
          ...
          className={`px-6 py-3 font-medium ${activeTab === 'stock'
            ? 'border-b-2 border-blue-500 text-blue-600'
            : 'text-gray-500 hover:text-gray-700'
            }`}
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {images.map((image) => (
                <div
                  ...
                  className={`relative aspect-square rounded-lg overflow-hidden cursor-pointer border-2 ${selectedImages.has(image.id)
                    ? 'border-blue-500'
